...
class DeduplicationService:
    ...
    def __init__(self, strategy: DeduplicationStrategy = DeduplicationStrategy.LOCATION):
        """
        ...
        logger.debug(f"DeduplicationService initialized with strategy: {strategy.value}")
