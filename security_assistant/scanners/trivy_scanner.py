...
from .base_scanner import ScannerNotInstalledError
...
class TrivyScanResult:
    ...
    def vulnerability_count(self) -> int:
        ...
        return len(
            [f for f in self.findings if f.pkg_type not in ["secret", "misconfig"]]
        )
    ...
    def packages(self) -> Set[str]:
        ...
        return {
            ...
            if f.pkg_type not in ["secret", "misconfig"]
        }
