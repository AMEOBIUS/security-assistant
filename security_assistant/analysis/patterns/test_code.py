...
class TestCodePattern:
    ...
    def __init__(self):
        ...
        self._path_patterns = [re.compile(p, re.IGNORECASE) for p in self.TEST_PATH_PATTERNS]
        self._file_patterns = [re.compile(p, re.IGNORECASE) for p in self.TEST_FILE_PATTERNS]
