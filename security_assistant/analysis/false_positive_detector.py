    ...
    def analyze(
        ...
        if code:
            ...
            if sanitization_score > 0.5:
                reasons.append(
                    f"Input sanitization detected (confidence: {sanitization_score:.2f})"
                )
        ...
        if code:
            ...
            if mock_score > 0.5:
                reasons.append(
                    f"Mock/test data detected (confidence: {mock_score:.2f})"
                )
        ...
        if code:
            ...
            if safe_context_score > 0.5:
                reasons.append(
                    f"Safe context detected (confidence: {safe_context_score:.2f})"
                )
